...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col md:flex-row pt-0">
      ...
      {/* Left Branding Panel */}
      <div 
        className="w-full md:w-5/12 p-6 sm:p-8 md:p-12 flex flex-col justify-between items-center min-h-[420px] md:min-h-screen relative overflow-hidden md:sticky md:top-0 md:h-screen border-r border-slate-200/60"
        style={{
      ...
      {/* Right Form Area with Sticky Sign In Button Container */}
      <div className="w-full md:w-7/12 bg-white flex items-center justify-center p-6 sm:p-10 lg:p-4">
        <div className="max-w-md w-full space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Sticky/Fixed Position Sign In Action Button Container */}
